		...
		Iterator<Polygon> itr = polygon.iterator();
	      while(itr.hasNext()) {
	         ...
	         if(element instanceof Triangle){
	        	 ...
	        	 System.out.println("Area of triangle is: " + df.format(element.getArea()));
	         }
	         if(element instanceof Rectangle){
	        	 System.out.println("Rectangle points are: " + element.getPoints());
	        	 System.out.println("Area of rectangle is: " + df.format(element.getArea()));
	         }
	      }
	      
	      PolygonTest1 test1 = new PolygonTest1();
	      test1.triangleGetArea();
	      test1.rectangleGetArea();
